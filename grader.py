...
-----------------------------
Milestone 4 answer:
TODO: Increasing number of epochs will reduce Training Error;
 However, Validation does not reduces simultaneously!!
"""
...
def test4a2():
    ...
    featureExtractor = submission.extractWordFeatures   # MileStone 5 專用：extractCharacterFeatures(4)
...
# TODO: Yes! using extractCharacterFeatures will train our model too well, thus
#  allowing Training Error to reach plateau quicker than using extractCharacterFeatures.
############################################################
